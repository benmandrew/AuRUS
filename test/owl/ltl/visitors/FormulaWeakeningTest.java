...
class FormulaWeakeningTest {
    ...
    void testWeaken1() throws IOException {
        ...
        System.out.println("Before weaken subformula! " + f.formula() + " mutation rate=" + FormulaUtils.formulaSize(f.formula()));
        FormulaWeakening weakener = new FormulaWeakening(vars, FormulaUtils.formulaSize(f.formula()), 5);
